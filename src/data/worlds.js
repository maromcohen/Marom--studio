...
// is an AI-generated moving environment, centred on the camera path.
...
export const WORLDS = [
  ...
  {
    id: 'process', z: -68, x: 0, y: 0, color: '#8fb4ff', fog: '#060a1a',
  ...
  {
    id: 'contact', z: -86, x: 0, y: 0, color: '#ffd98f', fog: '#161003',
